...
public class NodeUtility
{
	...
	public Node readFile(Node start)
	{
		try
		{
			FileInputStream fis=new FileInputStream("/home/bridgelabz/hash.txt");
			char ch;
			String word3="";
	...
	public int[] integerFileReader()
	{
		try
		{
			...
			FileReader fr = new FileReader("/home/bridgelabz/hash.txt");
  	...
  	public void writeFile(Node tNode)
	{
		...
		{
			String tString="";
		    File file=new File("/home/bridgelabz/P.txt");
		    file.createNewFile();
